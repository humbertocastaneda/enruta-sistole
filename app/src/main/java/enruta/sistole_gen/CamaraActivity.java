...
public class CamaraActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        nombrePredefinido=bu_params.getString("nombre");
        try{
    ...
    private PictureCallback mPicture = new PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
        	...
        	backButton.setVisibility(View.VISIBLE);
        	 if (globales.mostrarOtraFoto && nombrePredefinido.equals("") ){
...
//    	ls_nombre+= "_" + is_terminacion +".jpg";
    	...
    	if (!nombrePredefinido.equals("")){
    		ls_nombre="0"+nombrePredefinido;
    	}
    	else{
