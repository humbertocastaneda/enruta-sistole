...
public class Globales extends Application {
	 ...
	 */
	public int ii_pais=this.COMAPA_TAMPICO;
	...
	public int tipoDeValidacion=AMBAS;
	...
	/**Indica si se va a tomar foto a los no registrados**/
	boolean tomarFotoNoRegistrados=false;
	
	String nombre_foto="";
	
	String usuarioBD="u1003479_hcast";
	String serverBD= "db1003479_comapa";
