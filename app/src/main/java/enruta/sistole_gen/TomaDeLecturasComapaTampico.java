...
//		globales.switchBuscarPorMover=true;
		...
		globales.tomarFotoNoRegistrados=true;
...
// CE, REVISAR
	public String getNombreFoto(Globales globales, SQLiteDatabase db, long secuencial, String is_terminacion, String ls_anomalia ){
    	...
    	ls_nombre = Main.rellenaString(globales.tll.getLecturaActual().sinUso1.trim(), "0", globales.tlc.getLongCampo("poliza"), true) + "-";
...
//		} 		
	...
	public void regresaDeCamposGenericos(Bundle bu_params, String anomalia) {
		...
		if (anomalia.equals("noregistrados")) {
			...
			globales.nombre_foto=Main.rellenaString(bu_params.getString(String.valueOf(NUM_MEDIDOR)), "0",20, true) +"_" +
					Main.rellenaString(bu_params.getString(String.valueOf(LECTURA)), "0", 8, true)+"_"+
					Main.obtieneFecha("ymdhis")+".jpg";
			
			cadena +=globales.nombre_foto;
