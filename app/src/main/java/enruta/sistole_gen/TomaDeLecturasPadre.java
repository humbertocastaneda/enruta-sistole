...
//	 */
//	public void tomarFoto(int temporal, int cantidad, String ls_nombre ) {
//		tomarFoto( temporal, cantidad, "", ls_nombre ) ;
//	}
//	
	/**
	 ...
	 * @param Nombre de la foto
	 */
	public void tomarFoto(int temporal, int cantidad, String ls_anomalia, String ls_nombre ) {
		...
		if (globales.sonLecturasConsecutivas) {
			...
			tomarFoto(temporal, globales.tll.getLecturaActual(), cantidad, ls_anomalia, ls_nombre);
		}
	 ...
	 * @param cantidad Cantidad de fotos a tomar
	 */
	public void tomarFoto(int temporal, Lectura lectura, int cantidad, String ls_nombre) {
		tomarFoto( temporal,  lectura,  cantidad, "", ls_nombre);
	}
	 ...
	 */
	public void tomarFoto(int temporal, Lectura lectura, int cantidad, String ls_anomalia, String ls_nombre) {
		...
		camara.putExtra("nombre", ls_nombre);
		// vengoDeFotos = true;
